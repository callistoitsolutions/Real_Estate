...
#######################Start View Section For Property Related Pages#################################


def property_details_page(request):

    return render(request, "Property_Related_Page/property_details_page.html")




#######################End View Section For Property Related Pages#################################